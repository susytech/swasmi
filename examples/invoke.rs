...
use swasm::elements::{Internal, External, Type, FunctionType, ValueType};
use swasmi::{RuntimeValue, ModuleInstance, NopExternals, ImportsBuilder};
...
fn main() {
    ...
    let module = swasm::deserialize_file(&args[1]).expect("File to be deserialized");
    ...
    let loaded_module = swasmi::Module::from_swasm_module(module).expect("Module to be valid");

    // Intialize deserialized module. It adds module into It expects 3 parameters:
    // - a name for the module
    // - a module declaration
    // - "main" module doesn't import native module(s) this is why we don't need to provide external native modules here
    // This test shows how to implement native module https://github.com/NikVolf/swasm/blob/master/src/interpreter/tests/basics.rs#L197
